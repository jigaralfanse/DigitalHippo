            ...
            switch (_c.label) {
                ...
                case 2:
                    ...
                    if (filteredProducts.length === 0) {
                        throw new server_1.TRPCError({ code: 'BAD_REQUEST', message: 'No valid products found for checkout' });
                    }
                ...
                case 3:
                    ...
                    line_items.push({
                        price: 'price_1PY1EiKWqqQIVV1ElaHCREOk', // Ensure this is a valid price ID in your Stripe account
                        quantity: 1,
                        adjustable_quantity: {
                            enabled: false,
                        },
                ...
                case 5:
                    ...
                    console.log('Returning URL:', stripeSession.url);
